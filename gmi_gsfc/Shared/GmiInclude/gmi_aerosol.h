...
!=============================================================================
!
! $Id: gmi_aerosol.h,v 1.6 2013-07-31 14:55:15 ssteenro Exp $
!
! CODE DEVELOPER
!   Dan Bergmann, LLNL
!   dbergmann@llnl.gov
...
!     ---------------------------------------------------------------------
      ...
      integer, parameter :: NUM_AEROSOL = 39
...
!     ---------------------------------------------------
     ...
     &     2650.d0, 1500.d0, 1500.d0, 1769.d0, 1725.d0,  &
     &     2650.d0, 2650.d0, 1769.d0, 1769.d0 /)


!     ------------------------------------------------------
!     RADIUS_EFF : effective radius of each aerosol type (m)
!     ------------------------------------------------------
!... changing parameters for aerosols 20-22
!.old... 0.0405d-6, 0.2695d-6, 0.8270d-6
!.new... 0.3060d-6, 0.3060d-6, 0.3060d-6
     ...
     &     0.7500d-6, 1.5000d-6, 2.5000d-6, 4.0000d-6, 0.3060d-6,  &
     &     0.3060d-6, 0.3060d-6, 0.2600d-6, 1.1900d-6, 3.4300d-6,  &
     &     7.5700d-6, 0.7300d-6, 1.4000d-6, 2.3999d-6, 4.5006d-6,  &
     &     8.0006d-6, 0.2064d-6, 0.2130d-6, 0.2695d-6, 0.2695d-6,  &
     &     2.1000d-6, 7.5700d-6, 0.3417d-6, 0.1000d-6 /)
...
!     --------------------------------------------------------
     ...
     &      0.0000d0,  0.2789d0,  0.3926d0,  0.4809d0,  0.4809d0,  &
     &      0.0000d0,  0.0000d0,  0.4809d0,  0.4809d0 /)
     ...
     &      0.000d0,   3.115d0,   3.101d0,   3.082d0,   3.082d0,  &
     &      0.000d0,   0.000d0,   3.082d0,   3.082d0 /)
     ...
     &      0.000d-00, 5.415d-11, 4.190d-11, 3.110d-11, 3.110d-11,  &
     &      0.000d-00, 0.000d-00, 3.110d-11, 3.110d-11 /)
     ...
     &      0.000d0,  -1.399d0,  -1.404d0,  -1.428d0,  -1.428d0,  &
     &      0.000d0,   0.000d0,  -1.428d0,  -1.428d0 /)
...
!     ----------------------------------------------------------------
     ...
     &     1.0d0, 1.0d0, 1.0d0, 1.0d0, 1.0d0,  &
     &     1.0d0, 1.0d0, 1.0d0, 1.0d0, 1.0d0,  &
     &     1.0d0, 1.0d0, 0.5d0, 0.3d0, 0.3d0,  &
     &     0.3d0, 0.4d0, 0.4d0, 1.0d0, 1.0d0,  &
     &     0.4d0, 0.3d0, 1.0d0, 1.0d0 /)

...
!     ----------
      ...
      integer, parameter :: GMI_MAXSTR              = 256
      ...
      integer, parameter :: MAX_LENGTH_FILE_NAME    = GMI_MAXSTR !128
...
!     ----------------------------------------------------------------
      ...
      integer, parameter :: MAX_COL_DIAG_PRES  =   100 ! maximum number of pressures for column
                                                      ! diagnostic output
      integer, parameter :: MAX_COL_DIAG_SITES = 500 ! maximum number of column diagnostic sites
      ...
      integer, parameter :: num_AerDust        = 26   ! Number of entries for aerosol/dust 
                                                      ! diagnostics

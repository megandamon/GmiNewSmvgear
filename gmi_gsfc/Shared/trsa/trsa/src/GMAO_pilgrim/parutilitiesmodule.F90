...
!
! !INTERFACE: 
      SUBROUTINE ParInit ( Comm, npryzxy, mod_method, mod_geopk, mod_gatscat )
!
! !USES:
...
! Initialize mod_comm
      ...
      IF (.NOT. Initialized) THEN
         CALL mp_init( Comm, npryzxy, mod_method, mod_geopk, mod_gatscat )
...
! !LOCAL VARIABLES:
      ...
      CALL mp_sendirr( InComm, InBuf,Pattern%SendDesc,Pattern%RecvDesc,OutBuf )
!
...
!BOC
      ...
      CALL mp_sendirr_i4( InComm, InBuf,Pattern%SendDesc,Pattern%RecvDesc,OutBuf )
...
!BOC
      ...
      CALL mp_recvirr( InComm, OutBuf, Pattern%RecvDesc )
...
!BOC
      ...
      CALL mp_recvirr_i4( InComm, OutBuf, Pattern%RecvDesc )

!  $Id: MAPL_VarSpecMod.F90,v 1.2 2011-08-09 22:13:00 mrdamon Exp $
...
contains
  ...
  subroutine MAPL_VarSpecCreateInList(SPEC, SHORT_NAME, LONG_NAME,     &
                             UNITS,  Dims, VLocation, FIELD,NUM_SUBTILES, &
    ...
    integer :: szINAMES, szRNAMES, szIVALUES, szRVALUES
      ...
      if(present(FIELD)) then
         ...
         VERIFY_(STATUS)
         usableFIELD = ESMF_FieldCreateNoData(NAME=SHORT_NAME,RC=STATUS)
         VERIFY_(STATUS)
...
! Sanity checks
  ...
  subroutine MAPL_VarSpecGetData(SPEC, PTR1, PTR2, PTR3, RC)
    ...
    type(ESMF_Array) :: ARRAY
     ...
     call ESMF_FieldGetArray(SPEC%SPECPtr%FIELD,ARRAY,STATUS)
     VERIFY_(STATUS)
  ...
  subroutine MAPL_VarSpecGet(SPEC, SHORT_NAME, LONG_NAME, UNITS,       &
                             Dims, VLocation, FIELD,NUM_SUBTILES,      &
                             STAT, ACCMLT_INTERVAL, COUPLE_INTERVAL,   &
                             LABEL, DEFAULT,                           &
                             FRIENDLYTO,                               &
                             HALOWIDTH,                                &

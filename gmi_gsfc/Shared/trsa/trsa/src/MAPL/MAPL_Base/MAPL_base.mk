...
MOD_DIRS = $(INC_DIRS) $(INC_ESMF) $(INC_CFIO) 
...
GEOS_%.F90 : ../MAPL_%.F90
	@sed -e 's/MAPL_MetaComp/GEOS_GenericState/g' $< \
	|sed -e 's/MAPL_TerminateImport/GEOS_DoNotConnect/g'
	|sed -e 's/[Mm][Aa][Pp][Ll]_/GEOS_/g'  > $@

GEOS_%.P90 : ../MAPL_%.P90
	@sed -e 's/[Mm][Aa][Pp][Ll]_/GEOS_/g' -e 's/\.H/\.code/g' $< > $@

GEOS_ESMFL_Mod.F90 : ../ESMFL_Mod.F90
	@sed -e 's/[Mm][Aa][Pp][Ll]_/GEOS_/g' $< > $@

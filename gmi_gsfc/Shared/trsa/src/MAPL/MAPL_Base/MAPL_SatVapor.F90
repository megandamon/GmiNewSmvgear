...
!  $Id: MAPL_SatVapor.F90,v 1.2 2011-08-09 22:12:59 mrdamon Exp $
...
!  or saturation specific humidity (false). If never set, it is false; 
...
!    If MixingRation has been set using MAPL\_EQsatSet, it returns saturated
...
!    The choice of saturation vapor pressure formulation, and whether to use
!    a precomputed table or do the full calculation, is set with MAPL\_EQsatSET.
!    See MAPL\_EQsatSET for a full explanation of the behavior when
!    MAPL\_EQsatSET is not called.
! \newline
...
!    is computed over liquid or frozen water. If T is above 273.16K, the value returned
!    is always over liquid.
...
!   saturation specific humidity at $\frac{1}{2}$. In this case the derivative is set to zero.
! \newline
!
!EOPI

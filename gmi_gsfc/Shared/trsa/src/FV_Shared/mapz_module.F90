...
!dir$ prefervector
      ...
      do i = i1, i2
         ...
         do k = 1, kn+1
            ...
            enddo
            if ( k0(i,k) == -1 ) then
               print *, "Fault", i, j, pe2(i,km+1), pe1(i,km+1)
               k0(i,k) = km
            endif
         enddo
      enddo
...
! Prepare contribution between pe1(i,k0(i,k)+1) and pe1(i,k0(i,k+1))
           qsumk(:,k) = D0_0
           do i = i1, i2
              do kl = k0(i,k)+1, k0(i,k+1)-1
                 qsumk(i,k) = qsumk(i,k) + dp1(i,kl)*q4(1,i,kl)
...
!<debug>
        do k = 1, kn
           do i = i1, i2
              tracer(1)%content_r4(i,j,k) = pe1(i,k+1)
              tracer(2)%content_r4(i,j,k) = pe2(i,k+1)
           enddo
        enddo
!</debug>
#endif

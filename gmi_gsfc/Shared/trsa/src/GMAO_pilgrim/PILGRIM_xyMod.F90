...
! !USES:
      ...
      USE mod_comm, ONLY : commglobal, mp_sendirr_i4, mp_recvirr_i4
      IMPLICIT NONE
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_i4(commglobal, qin, this%scatter_2d%SendDesc,      &
                        this%scatter_2d%RecvDesc, qout)
      CALL mp_recvirr_i4(commglobal, qout,this%scatter_2d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_i4(commglobal, qin, this%gather_2d%SendDesc,                   &
                         this%gather_2d%RecvDesc, qout)
      CALL mp_recvirr_i4(commglobal, qout,this%gather_2d%RecvDesc)
!EOC
...
! !USES:
      ...
      USE mod_comm, ONLY : commglobal, mp_sendirr_r4, mp_recvirr_r4
      IMPLICIT NONE
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_r4(commglobal, qin, this%scatter_2d%SendDesc,                  &
                        this%scatter_2d%RecvDesc, qout)
      CALL mp_recvirr_r4(commglobal, qout,this%scatter_2d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_r4(commglobal, qin, this%gather_2d%SendDesc,                   &
                         this%gather_2d%RecvDesc, qout)
      CALL mp_recvirr_r4(commglobal, qout,this%gather_2d%RecvDesc)
!EOC
...
! !USES:
      ...
      USE mod_comm, ONLY : commglobal, mp_sendirr, mp_recvirr
      IMPLICIT NONE
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr(commglobal, qin, this%scatter_2d%SendDesc,                  &
                        this%scatter_2d%RecvDesc, qout)
      CALL mp_recvirr(commglobal, qout,this%scatter_2d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr(commglobal, qin, this%gather_2d%SendDesc,                   &
                         this%gather_2d%RecvDesc, qout)
      CALL mp_recvirr(commglobal, qout,this%gather_2d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_i4(commglobal, qin, this%scatter_3d%SendDesc,                  &
                        this%scatter_3d%RecvDesc, qout)
      CALL mp_recvirr_i4(commglobal, qout,this%scatter_3d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_i4(commglobal, qin, this%gather_3d%SendDesc,                   &
                         this%gather_3d%RecvDesc, qout)
      CALL mp_recvirr_i4(commglobal, qout,this%gather_3d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_r4(commglobal, qin, this%scatter_3d%SendDesc,                  &
                        this%scatter_3d%RecvDesc, qout)
      CALL mp_recvirr_r4(commglobal, qout,this%scatter_3d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr_r4(commglobal, qin, this%gather_3d%SendDesc,                   &
                         this%gather_3d%RecvDesc, qout)
      CALL mp_recvirr_r4(commglobal, qout,this%gather_3d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr(commglobal, qin, this%scatter_3d%SendDesc,                  &
                        this%scatter_3d%RecvDesc, qout)
      CALL mp_recvirr(commglobal, qout,this%scatter_3d%RecvDesc)
!EOC
...
!BOC
      ...
      ENDIF
      CALL mp_sendirr(commglobal, qin, this%gather_3d%SendDesc,          &
                         this%gather_3d%RecvDesc, qout)
      CALL mp_recvirr(commglobal, qout,this%gather_3d%RecvDesc)
!EOC

...
!
! !USES:
      use m_FastjJvaluesVars  , only : NJVAL, TQQ, QO2, QO3, Q1D, TITLEJ
      use m_FastjJvaluesVars  , only : NW1, NW2, QQQ
      use m_FastjCTMparameters, only : L1_, W_, JVL_, X_
...
! !USES:
!
      use m_FastjCTMparameters, only : L1_, L2_
!
      implicit none
!
! !INPUT PARAMETERS:
...
!
! !USES:
      use m_FastjCTMparameters, only : X_
      use m_FastjJvaluesVars  , only : TQQ   , QQQ   , QRAYL
      use m_FastjJvaluesVars  , only : QO2   , QO3   , Q1D
      use m_FastjJvaluesVars  , only : WBIN  , WL    , FL 
      use m_FastjJvaluesVars  , only : NJVAL , NW1   , NW2
      use m_FastjJvaluesVars  , only : TITLE0, TITLEJ, TITLEJ2, TITLEJ3
!
      implicit none
!
! !INPUT PARAMETERS:
...
! !USES:
!
      use m_FastjJvaluesVars  , only : NAA, QAA, WAA, PAA, RAA, SSA
      use m_FastjJvaluesVars  , only : JTAUMX, ATAU, ATAU0
      use m_FastjJvaluesVars  , only : TITLE0, TITLEA
...
! !USES:
!
      use m_FastjJvaluesVars   , only : QAA, SSA, PAA, ATAU0
      use m_FastjCTMparameters , only : L1_, L2_, L_
      use m_FastjMIEparameters , only : M_, N_
      use m_FastjCoreScattering, only : MIESCT
!
      implicit none
!
!

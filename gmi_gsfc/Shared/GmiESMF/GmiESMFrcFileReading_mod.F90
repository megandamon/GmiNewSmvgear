...
!
! !DESCRIPTION:
! Read in a table of real numbers from a resource file.
!
! !LOCAL VARIABLES:
      logical :: endTable
...
!     
! !DESCRIPTION:
! Read in a table of words from a resource file.
!
! !LOCAL VARIABLES:
      integer :: STATUS
...
!
! !DESCRIPTION:
! Read in a logical variable from a resource file.
...
!BOC
      ...
      call ESMF_ConfigGetChar(config, cValue, label, default=cDefault, rc=STATUS )
      VERIFY_(STATUS)
...
!
! !DESCRIPTION:
!  This routine takes a long string and reconstruct the phrase/name
!  it represents.
!
! !LOCAL VARIABLES:

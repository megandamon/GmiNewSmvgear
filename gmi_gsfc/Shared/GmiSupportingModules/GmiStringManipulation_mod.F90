...
!
      ...
      public  :: convertCharacters2String
!
! !DESCRIPTION:
...
!
! !DESCRIPTION:
!  Writes out a single precision real variable at the prescribed format.
!
! !AUTHOR:
!  Jules Kouatchou
!
...
!
! !DESCRIPTION:
!  Writes out a double precision real variable at the prescribed format.
!
! !AUTHOR:
!  Jules Kouatchou
!
...
!-------------------------------------------------------------------------
!BOP
      function convertCharacters2String(arrayChars) result(charString)

      implicit none
!
! !INPUT PARAMETERS:
      character arrayChars(:)
!
! !RETURN VALUE:
      character (len=size(arrayChars)) charString
!
! !DESCRIPTION:
! This function converts an array of characters into a character string.
!
! !LOCAL VARIABLES:
      integer :: i
!
...
!-------------------------------------------------------------------------
!BOC
      charString(1:1)=arrayChars(1)
      do i=2,size(arrayChars)
         charString(1:i) = charString(1:i-1)//arrayChars(i)
      enddo

      end function convertCharacters2String
!EOC
!-------------------------------------------------------------------------

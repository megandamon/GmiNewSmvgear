...
!  INTEGER :: lwi_flags (i1:i2, ju1:j2)     ! land, water, ice indicator
  REAL*8            :: c0(5), b0(2)
!  REAL*8, PARAMETER :: c_old(5)=(/1.373, 3.00, 0.057, 1.05, 1.190/)
!  REAL*8, PARAMETER :: c_new(5)=(/1.373, 3.00, 0.057, 3.45, 1.607/)
  REAL*8, PARAMETER :: c_old(5)=(/1.373, 3.20, 0.057, 1.05, 1.190/)
  REAL*8, PARAMETER :: c_new(5)=(/1.373, 3.20, 0.057, 3.45, 1.607/)

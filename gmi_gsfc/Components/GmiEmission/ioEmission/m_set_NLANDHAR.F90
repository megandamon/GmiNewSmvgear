...
!
! !DEFINED PARAMETERS:
      integer, parameter :: NLANDHAR_1DEG = 10739   ! 1x1.25 horizontal resolution
      integer, parameter :: NLANDHAR_2x2DEG = 5203 ! 2x2 horizontal resolution
...
!BOC
      ...
      Case (180)
         NLANDHAR_expected = NLANDHAR_2x2DEG
      Case (144)

...
!=============================================================================
!
! $Id: smv2chem_init.F90,v 1.5 2013-09-03 16:16:43 jkouatch Exp $
!
! CODE DEVELOPER
...
!-----------------------------------------------------------------------------
      ...
      subroutine Do_Smv2_Init (savedVars, smv_filnam, do_smv_reord, &
                               pr_diag, pr_smv2, loc_proc, chemintv, &
                               tdt, i1, i2, ju1, j2, k1, k2, &
...
!     ----------------------
      ...
      logical, intent(in) :: pr_qqjk, do_qqjk_inchem
...
!c    ylow     (ncs) = YLOWIN
      ...
      if (pr_qqjk .and. do_qqjk_inchem) then
         call initSMV2diag(savedVars, tdt, i1, i2, ju1, j2, k1, k2, &
                            ilong, ilat, ivert, itloop, &
                            num_qjs, num_qks, num_active, pr_nc_period)
      endif

      call Jsparse(savedVars, pr_smv2, savedVars%lunsmv, savedVars%ncs,&

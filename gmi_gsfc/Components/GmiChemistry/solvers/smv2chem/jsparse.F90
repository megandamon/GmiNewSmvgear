...
!=============================================================================
!
! $Id: jsparse.F90,v 1.4 2013-09-03 16:16:43 jkouatch Exp $
!
! CODE DEVELOPER
...
!-----------------------------------------------------------------------------
      ...
      subroutine Jsparse (savedVars, pr_smv2, lunsmv, ncs, &
...
!     -------------------------------------------------
     ...
     &                MAXGL, ngnfrac(ncs)
      ...
      if (pr_smv2) then
        Write (lunsmv,840)  &
     &    savedVars%nallrat(ncsp), savedVars%nallrat(ncs)-savedVars%nallrat(ncsp), savedVars%nallrat(ncs)
      end if
...
!-----------------------------------------------------------------------------
      ...
      subroutine Ksparse (savedVars, pr_smv2, lunsmv, ncs, ncsp, lzero, &

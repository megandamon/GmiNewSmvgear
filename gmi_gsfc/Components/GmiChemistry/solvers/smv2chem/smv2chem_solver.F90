...
!=============================================================================
!
! $Id: smv2chem_solver.F90,v 1.6 2013-09-03 16:16:43 jkouatch Exp $
!
! CODE DEVELOPER
...
!     ----------------
      ...
      call Physproc (savedVars, do_qqjk_inchem, do_semiss_inchem, &
               ...
               savedVars%csumc, errmx2, cx, yda, qqkda, qqjda, &

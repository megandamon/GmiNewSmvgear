!=============================================================================
!
! $Id: gas_sulfchem.F90,v 1.1 2006-06-14 20:50:40 kouatch Exp $
!
! CODE DEVELOPER
...
!-----------------------------------------------------------------------------
     ...
     &  (dtclc, itloop, cp, dcp, cfac, zmp, semiss, srcgas,  &
     &   oh, ho2, h2o, no3,  &
...
! -------------------------------------------------------------
      ...
      sfso2(:) = semiss(:, IFSO2)  &
     &         * 0.98d0           ! 98% of anthropogenic sulfur emission as SO2
      snso2(:) = semiss(:, INSO2)
      sndms(:) = semiss(:, INDMS)

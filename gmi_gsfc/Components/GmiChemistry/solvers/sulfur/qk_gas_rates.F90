!=============================================================================
!
! $Id: qk_gas_rates.F90,v 1.3 2013-07-31 14:22:07 ssteenro Exp $
!
! CODE DEVELOPER
...
!.sds... newer rates from full chem - causes failure coming out of polar night around 3 hPa
!        qh3p(ijk) = 3.5d-13 * exp(430.d0 / tpp(ijk))  &
!     &            + 1.7d-33 * zmp(ijk) * exp(1000.d0 / tpp(ijk))
...
!.sds... newer rates from full chem
!        qh5p(ijk) = 1.8d-12 * exp(0.d0 / tpp(ijk))
...
!.sds... newer rates from full chem - causes failure coming out of polar night around 3 hPa
!        qh8p(ijk) = (3.5d-13 * exp(430.d0 / tpp(ijk))  &
!     &            + 1.7d-33 * zmp(ijk) * exp(1000.d0 / tpp(ijk)))  &
!     &            * 1.4d-21 * exp(2200.d0 / tpp(:))

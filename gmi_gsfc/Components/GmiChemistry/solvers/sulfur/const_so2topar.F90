!=============================================================================
!
! $Id: const_so2topar.F90,v 1.6 2012-01-05 21:41:30 jkouatch Exp $
!
! CODE DEVELOPER
...
#     include "sulfchem.h"
      ...
      integer, parameter :: IDUST1_l   = 1
      integer, parameter :: IDUST2_l   = 1
      integer, parameter :: IDUST3_l   = 1
      integer, parameter :: IDUST4_l   = 1
      integer, parameter :: ISSLT1_l   = 1
      integer, parameter :: ISSLT2_l   = 1
      integer, parameter :: ISSLT3_l   = 1
      integer, parameter :: ISSLT4_l   = 1
      integer, parameter :: IFSO4D1_l  = 1
      integer, parameter :: IFSO4D2_l  = 1
      integer, parameter :: IFSO4D3_l  = 1
      integer, parameter :: IFSO4D4_l  = 1
      integer, parameter :: INSO4D1_l  = 1
      integer, parameter :: INSO4D2_l  = 1
      integer, parameter :: INSO4D3_l  = 1
      integer, parameter :: INSO4D4_l  = 1
      integer, parameter :: IFSO4S1_l  = 1
      integer, parameter :: IFSO4S2_l  = 1
      integer, parameter :: IFSO4S3_l  = 1
      integer, parameter :: IFSO4S4_l  = 1
      integer, parameter :: INSO4S1_l  = 1
      integer, parameter :: INSO4S2_l  = 1
      integer, parameter :: INSO4S3_l  = 1
      integer, parameter :: INSO4S4_l  = 1
      ...
      integer, parameter :: IDUST1_l   = IDUST1
      integer, parameter :: IDUST2_l   = IDUST2
      integer, parameter :: IDUST3_l   = IDUST3
      integer, parameter :: IDUST4_l   = IDUST4
      integer, parameter :: ISSLT1_l   = ISSLT1
      integer, parameter :: ISSLT2_l   = ISSLT2
      integer, parameter :: ISSLT3_l   = ISSLT3
      integer, parameter :: ISSLT4_l   = ISSLT4
      integer, parameter :: IFSO4D1_l  = IFSO4D1
      integer, parameter :: IFSO4D2_l  = IFSO4D2
      integer, parameter :: IFSO4D3_l  = IFSO4D3
      integer, parameter :: IFSO4D4_l  = IFSO4D4
      integer, parameter :: INSO4D1_l  = INSO4D1
      integer, parameter :: INSO4D2_l  = INSO4D2
      integer, parameter :: INSO4D3_l  = INSO4D3
      integer, parameter :: INSO4D4_l  = INSO4D4
      integer, parameter :: IFSO4S1_l  = IFSO4S1
      integer, parameter :: IFSO4S2_l  = IFSO4S2
      integer, parameter :: IFSO4S3_l  = IFSO4S3
      integer, parameter :: IFSO4S4_l  = IFSO4S4
      integer, parameter :: INSO4S1_l  = INSO4S1
      integer, parameter :: INSO4S2_l  = INSO4S2
      integer, parameter :: INSO4S3_l  = INSO4S3
      integer, parameter :: INSO4S4_l  = INSO4S4
#endif
...
!     The molecular weight of Ca is 40.08.
      ...
      do ijk = 1, itloop
        ...
        dust(ijk,1) = cp(ijk, IDUST1_l)
        dust(ijk,2) = cp(ijk, IDUST2_l)
        dust(ijk,3) = cp(ijk, IDUST3_l)
        dust(ijk,4) = cp(ijk, IDUST4_l)

        sslt(ijk,1) = cp(ijk, ISSLT1_l)
        sslt(ijk,2) = cp(ijk, ISSLT2_l)
        sslt(ijk,3) = cp(ijk, ISSLT3_l)
        sslt(ijk,4) = cp(ijk, ISSLT4_l)
...
!     These are the mtj
        ...
        do ijk = 1, itloop
          ...
          smd(ijk,1) = cp(ijk, IFSO4D1_l) + cp(ijk, INSO4D1_l)
          smd(ijk,2) = cp(ijk, IFSO4D2_l) + cp(ijk, INSO4D2_l)
          smd(ijk,3) = cp(ijk, IFSO4D3_l) + cp(ijk, INSO4D3_l)
          smd(ijk,4) = cp(ijk, IFSO4D4_l) + cp(ijk, INSO4D4_l)

          sms(ijk,1) = cp(ijk, IFSO4S1_l) + cp(ijk, INSO4S1_l)
          sms(ijk,2) = cp(ijk, IFSO4S2_l) + cp(ijk, INSO4S2_l)
          sms(ijk,3) = cp(ijk, IFSO4S3_l) + cp(ijk, INSO4S3_l)
          sms(ijk,4) = cp(ijk, IFSO4S4_l) + cp(ijk, INSO4S4_l)
...
!     *----------------------------------------------------------------
        ...
        do ijk = 1, itloop
          ...
          dfz(ijk) = cp(ijk, IFSO2_l) *  &
     &               ( exp( - rtctot(ijk) * dtcyc ) - 1.0d0 )
          dnz(ijk) = cp(ijk, INSO2_l) *  &
     &               ( exp( - rtctot(ijk) * dtcyc ) - 1.0d0 )
...
!.... fossil
          ...
          do i = 1, 4
            ...
            where ( dfz(:) .lt. - cp(:, IFSO2_l) )

              frso2    = - cp(:, IFSO2_l) / dfz(:)
              dfz(:) = - cp(:, IFSO2_l)
...
!.... natural
          ...
          do i = 1, 4
            ...
            where ( dnz(:) .lt. - cp(:, INSO2_l) )

              frso2    = - cp(:, INSO2_l) / dnz(:)
              dnz(:) = - cp(:, INSO2_l)
...
!.... debug end
        ...
        cp(:, IFSO2_l) = cp(:, IFSO2_l) + dfz(:)
        cp(:, INSO2_l) = cp(:, INSO2_l) + dnz(:)

        cp(:, IFSO4D1_l) = cp(:, IFSO4D1_l) + dfmd(:,1)
        cp(:, IFSO4D2_l) = cp(:, IFSO4D2_l) + dfmd(:,2)
        cp(:, IFSO4D3_l) = cp(:, IFSO4D3_l) + dfmd(:,3)
        cp(:, IFSO4D4_l) = cp(:, IFSO4D4_l) + dfmd(:,4)

        cp(:, IFSO4S1_l) = cp(:, IFSO4S1_l) + dfms(:,1)
        cp(:, IFSO4S2_l) = cp(:, IFSO4S2_l) + dfms(:,2)
        cp(:, IFSO4S3_l) = cp(:, IFSO4S3_l) + dfms(:,3)
        cp(:, IFSO4S4_l) = cp(:, IFSO4S4_l) + dfms(:,4)

        cp(:, INSO4D1_l) = cp(:, INSO4D1_l) + dnmd(:,1)
        cp(:, INSO4D2_l) = cp(:, INSO4D2_l) + dnmd(:,2)
        cp(:, INSO4D3_l) = cp(:, INSO4D3_l) + dnmd(:,3)
        cp(:, INSO4D4_l) = cp(:, INSO4D4_l) + dnmd(:,4)

        cp(:, INSO4S1_l) = cp(:, INSO4S1_l) + dnms(:,1)
        cp(:, INSO4S2_l) = cp(:, INSO4S2_l) + dnms(:,2)
        cp(:, INSO4S3_l) = cp(:, INSO4S3_l) + dnms(:,3)
        cp(:, INSO4S4_l) = cp(:, INSO4S4_l) + dnms(:,4)

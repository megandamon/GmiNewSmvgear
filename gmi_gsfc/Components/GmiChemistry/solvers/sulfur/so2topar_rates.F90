!=============================================================================
!
! $Id: so2topar_rates.F90,v 1.8 2013-09-03 16:16:43 jkouatch Exp $
!
! CODE DEVELOPER
...
!          ========
      call chemst62  &
!          ========
     &  (sulfSavedVars, denom, nr, r, dndrt, rdry, aqua_infile_name)
...
!       ===========
          ...
          sulfSavedVars%rdryss(nr1,i)  = 1.d-4 * fwk(1)
          sulfSavedVars%rss(nr1,i)     = 1.d-4 * fwk(2)
          sulfSavedVars%dndrtss(nr1,i) = fwk(3)
...
!     ===========
      ...
      nr(i)      = sulfSavedVars%nrss(i)
      rdry (:,i) = sulfSavedVars%rdryss (:,i)
      r    (:,i) = sulfSavedVars%rss    (:,i)
      dndrt(:,i) = sulfSavedVars%dndrtss(:,i)

!=============================================================================
!
! $Id: qk_aqu_rates.F90,v 1.3 2013-07-31 14:21:16 ssteenro Exp $
!
! CODE DEVELOPER
...
!     ----------------------
      ...
      real*8, intent(in) :: o3   (itloop)
      real*8, intent(in) :: cwac (itloop)
      real*8, intent(in) :: zmair(itloop)
      ...
      real*8, intent(out) :: qh6
      real*8, intent(out) :: qh7p (itloop)
      real*8, intent(in) :: qh8p (itloop)
      real*8, intent(in) :: qh9p (itloop)
      real*8, intent(out) :: hwp  (itloop)
      real*8, intent(out) :: hyp  (itloop)
      real*8, intent(out) :: h3p  (itloop)
      real*8, intent(out) :: acoef(itloop, 9)
...
!     constant for all grid points: SO2(aq) + H2O2(aq) -> H2SO4
!
!          ======
      call chemk6  &
!          ======
...
!.... aqueous reaction rates (qh7p): SO2(aq) + O3(aq) -> H2SO4 + O2
!
!          ======
      call chemk7  &
!          ======
...
!     ----------------------
      ...
      integer, intent(in) :: itloop, numcl

      integer, intent(in) :: idxcl(itloop)

      real*8, intent(in)  :: tpp(itloop)
      real*8, intent(out) :: hwp(itloop)
      real*8, intent(out) :: hyp(itloop)
      real*8, intent(out) :: h3p(itloop)
...
!     ----------------------
      ...
      real*8, intent(in)  :: o3p (itloop)

      real*8, intent(in)  :: hwp (itloop)
      real*8, intent(in)  :: hyp (itloop)
      real*8, intent(in)  :: h3p (itloop)

      real*8, intent(in)  :: cwp (itloop)
      ...
      real*8, intent(in)  :: qj4p(itloop)
      real*8, intent(in)  :: qh5p(itloop)
      real*8, intent(in)  :: qh6
      real*8, intent(in)  :: qh7p(itloop)
      real*8, intent(in)  :: qh8p(itloop)
      real*8, intent(in)  :: qh9p(itloop)

      real*8, intent(out) :: a   (itloop, 9)

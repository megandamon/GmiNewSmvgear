!=======================================================================
!
! $Id: setkin_kcalc.F90,v 1.14 2013-07-31 16:35:38 ssteenro Exp $
!
! ROUTINE
...
!new      rcarr(102,:) = skch4pcl(  8.900D-13 , 660.0D+00 ,temperature)
!
!....           CH2O + Cl = CO + HCl + HO2
!
...
!....           BrONO2 = HNO3 + HOBr
!
!.no_het..      rcarr(294,:) = 0.0d0
      rcarr(294,:) = sksts_brono2 (temperature  & 
     &           ,pressure ,sad_lbs ,tropp)
!
!....           ClONO2 + HCl = Cl2 + HNO3
!
!.no_het..      rcarr(295,:) = 0.0d0
...
!....           BrONO2 = HNO3 + HOBr
!
!.no_het..      rcarr(300,:) = 0.0d0
      rcarr(300,:) = sksts_brono2 (temperature  & 
     &           ,pressure ,sad_sts ,tropp)
!
!....           ClONO2 + HCl = Cl2 + HNO3
!
!.no_het..      rcarr(301,:) = 0.0d0
...
!
     ...
     &      af ,ae ,tk(:)
        ...
        END FUNCTION skarr
!new
!new        FUNCTION skch4pcl (af,ae,tk)
!new          real*8 &
!new     &      af ,ae ,tk(:)
!new          real*8, dimension(size(tk)) :: skch4pcl
!new          skch4pcl(:) = af * (tk(:)/298.d0)**2 * exp(-ae / tk(:))
!new        END FUNCTION skch4pcl
!new

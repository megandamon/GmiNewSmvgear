!=======================================================================
!
! $Id: setkin_lchem.h,v 1.8 2011-08-09 22:52:11 mrdamon Exp $
!
! FILE
...
!
      ...
      data lchemvar(121) /"Total density"/
      data lchemvar(122) /"DEHYD"/
      data lchemvar(123) /"H2OAIR"/
      data lchemvar(124) /"SYNOZ"/
!
...
!
      ...
      data ldynvar(118) /"DEHYD"/
      data ldynvar(119) /"H2OAIR"/
      data ldynvar(120) /"SYNOZ"/
!

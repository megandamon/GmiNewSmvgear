!=======================================================================
!
! $Id: setkin_mw.h,v 1.1 2006-07-03 02:54:25 kouatch Exp $
!
! CODE DEVELOPER
!   Peter Connell, LLNL
!   connell2@llnl.gov
...
!=======================================================================
     ...
     &   28.96d0,   28.96d0,   28.96d0,   28.96d0,  &
     &   28.96d0,   28.96d0,   28.96d0,   28.96d0,  &
     &   28.96d0,   28.96d0,   48.00d0,   17.01d0,  &
     &   33.01d0,   62.00d0,   28.88d0 /

!   aerosol molecular weight is set to be MWAIR,
!   so that mole_fraction = 1, and mass mixing ratio will be used.
!   unit of gas species: mol/mol, unit of aerosols: g/g air.

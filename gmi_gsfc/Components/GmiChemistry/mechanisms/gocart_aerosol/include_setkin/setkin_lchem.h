!=======================================================================
!
! $Id: setkin_lchem.h,v 1.1 2006-07-03 02:54:25 kouatch Exp $
!
! FILE
...
!
      ...
      data lchemvar(22) /"dust5"/
      data lchemvar(23) /"sslt1"/
      data lchemvar(24) /"sslt2"/
      data lchemvar(25) /"sslt3"/
      data lchemvar(26) /"sslt4"/
      data lchemvar(27) /"O3"/
      data lchemvar(28) /"OH"/
      data lchemvar(29) /"HO2"/
      data lchemvar(30) /"NO3"/
      data lchemvar(31) /"ad"/
!
...
!
      ...
      data ldynvar(22) /"dust5"/
      data ldynvar(23) /"sslt1"/
      data ldynvar(24) /"sslt2"/
      data ldynvar(25) /"sslt3"/
      data ldynvar(26) /"sslt4"/
      data ldynvar(27) /"O3"/
      data ldynvar(28) /"OH"/
      data ldynvar(29) /"HO2"/
      data ldynvar(30) /"NO3"/

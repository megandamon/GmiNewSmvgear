!=======================================================================
!
! $Id: setkin_lchem.h,v 1.1 2013-07-31 15:35:22 ssteenro Exp $
!
! FILE
...
!
      ...
      data lchemvar(118) /"nDMS"/
      data lchemvar(119) /"nSO2"/
      data lchemvar(120) /"fSO2"/
      data lchemvar(121) /"nSO4n1"/
      data lchemvar(122) /"nSO4n2"/
      data lchemvar(123) /"nSO4n3"/
      data lchemvar(124) /"nSO4a"/
      data lchemvar(125) /"fSO4n1"/
      data lchemvar(126) /"fSO4n2"/
      data lchemvar(127) /"fSO4n3"/
      data lchemvar(128) /"fSO4a"/
      data lchemvar(129) /"NO3an1"/
      data lchemvar(130) /"NO3an2"/
      data lchemvar(131) /"NO3an3"/
      data lchemvar(132) /"ACET"/
      data lchemvar(133) /"N2"/
      data lchemvar(134) /"O2"/
      data lchemvar(135) /"Total density"/
      data lchemvar(136) /"DEHYD"/
      data lchemvar(137) /"DUST1"/
      data lchemvar(138) /"DUST2"/
      data lchemvar(139) /"DUST3"/
      data lchemvar(140) /"DUST4"/
      data lchemvar(141) /"DUST5"/
      data lchemvar(142) /"H2OAIR"/
      data lchemvar(143) /"NH3"/
      data lchemvar(144) /"NH4a"/
      data lchemvar(145) /"SSLT1"/
      data lchemvar(146) /"SSLT2"/
      data lchemvar(147) /"SSLT3"/
      data lchemvar(148) /"SSLT4"/
      data lchemvar(149) /"SYNOZ"/
      data lchemvar(150) /"bBC"/
      data lchemvar(151) /"bOC"/
      data lchemvar(152) /"fBC"/
      data lchemvar(153) /"fOC"/
      data lchemvar(154) /"nOC"/
!
...
!
      ...
      data ldynvar(118) /"nDMS"/
      data ldynvar(119) /"nSO2"/
      data ldynvar(120) /"fSO2"/
      data ldynvar(121) /"nSO4n1"/
      data ldynvar(122) /"nSO4n2"/
      data ldynvar(123) /"nSO4n3"/
      data ldynvar(124) /"nSO4a"/
      data ldynvar(125) /"fSO4n1"/
      data ldynvar(126) /"fSO4n2"/
      data ldynvar(127) /"fSO4n3"/
      data ldynvar(128) /"fSO4a"/
      data ldynvar(129) /"NO3an1"/
      data ldynvar(130) /"NO3an2"/
      data ldynvar(131) /"NO3an3"/
      data ldynvar(132) /"DEHYD"/
      data ldynvar(133) /"DUST1"/
      data ldynvar(134) /"DUST2"/
      data ldynvar(135) /"DUST3"/
      data ldynvar(136) /"DUST4"/
      data ldynvar(137) /"DUST5"/
      data ldynvar(138) /"H2OAIR"/
      data ldynvar(139) /"NH3"/
      data ldynvar(140) /"NH4a"/
      data ldynvar(141) /"SSLT1"/
      data ldynvar(142) /"SSLT2"/
      data ldynvar(143) /"SSLT3"/
      data ldynvar(144) /"SSLT4"/
      data ldynvar(145) /"SYNOZ"/
      data ldynvar(146) /"bBC"/
      data ldynvar(147) /"bOC"/
      data ldynvar(148) /"fBC"/
      data ldynvar(149) /"fOC"/
      data ldynvar(150) /"nOC"/
!

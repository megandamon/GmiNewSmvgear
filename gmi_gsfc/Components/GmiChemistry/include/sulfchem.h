...
!=============================================================================
!
! $Id: sulfchem.h,v 1.6 2013-09-03 16:16:43 jkouatch Exp $
!
! FILE
!   sulfchem.h
!
...
!     -----------
      ...
      integer, parameter :: NOCYC = 5             ! number of sub-cycles in chem60 dtchem

      real*8, parameter :: ALONUM  =   2.68719d19 ! Loschmidt's Number (molecules/cm^3)
      real*8, parameter :: FRDUST  =   0.05       ! fraction of dust     molecules available
                                                  !   to dissolve SO4
      real*8, parameter :: FRSSLT  =   0.005      ! fraction of sea salt molecules available
                                                  !   to dissolve SO4
      real*8, parameter :: GC      =   8.317d7    ! gas constant (ergs/K/mole or cm3*dynes/cm^3)
      real*8, parameter :: PI      =   3.141592653589793d0
      real*8, parameter :: WTMAIR  =  28.88 ! molecular weight of air              (g/mol)
      real*8, parameter :: WTMDUST = 100.09 ! molecular weight of dust     (CaCO3) (g/mol)
      real*8, parameter :: WTMSO2  =  64.06 ! molecular weight of SO2              (g/mol)
      real*8, parameter :: WTMSO4  =  98.08 ! molecular weight of H2SO4            (g/mol)
      real*8, parameter :: WTMSSLT =  58.45 ! molecular weight of sea salt (NaCl)  (g/mol)

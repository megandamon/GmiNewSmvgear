...
!=============================================================================
!
! $Id: smv2chem_par.h,v 1.8 2013-07-31 14:58:15 ssteenro Exp $
!
! CODE DEVELOPER
...
!      integer, parameter :: KBLOOP   =  25
!      integer, parameter :: KULOOPIN =  25
        integer, parameter :: KBLOOP   =   20
        integer, parameter :: KULOOPIN =   20
!.geos5        integer, parameter :: KBLOOP   =   32
!.geos5        integer, parameter :: KULOOPIN =   32
!.orig        integer, parameter :: KBLOOP   =   75
!.orig        integer, parameter :: KULOOPIN =   75
...
!     ====
        ...
        integer, parameter :: KBLOOP   =  500
        integer, parameter :: KULOOPIN =  500
        integer, parameter :: MXBLOCK  = 7500

! $Id: fastj_control.F90,v 1.13 2011-08-09 22:12:58 mrdamon Exp $
      module fastj
...
!     num_qj_o3_to_2oh : index of O3 -> O1d photolysis IF it is actually
...
!-----------------------------------------------------------------------------
     ...
     &   month_gmi, jday, time_sec, fastj_offset_sec, londeg_i,  &
     &   latdeg_j, press3e_ij, kel_ij, optdepth_ij,  &
...
! ---------------------------------------------------------------------
     ...
     &     num_qj_o3_to_2oh, num_qjs, chem_mask_khi, k2, k1)

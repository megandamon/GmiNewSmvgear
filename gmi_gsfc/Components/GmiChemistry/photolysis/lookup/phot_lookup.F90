...
!=============================================================================
!
! $Id: phot_lookup.F90,v 1.15 2011-08-08 19:56:02 mrdamon Exp $
!
! CODE DEVELOPER
...
!-----------------------------------------------------------------------------
      ...
      subroutine Lookup_Qj  &
     &  (do_clear_sky, phot_opt, io3_num, nymd, photintv, rsec_jan1, press3c,  &
     &   kel, concentration, latdeg, mcor, mass, fracCloudCover, qjgmi, &
     &   pr_diag, loc_proc, num_species, num_qjs, num_qjo, ilo, ihi, julo, jhi,&
     &   i2_gl, ju1_gl, j2_gl, i1, i2, ju1, j2, k1, k2, chem_mecha)
